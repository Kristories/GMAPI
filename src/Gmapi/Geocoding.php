...
class Geocoding {
	...
	public function run()
	{
		...
		$url 						= $this->_protocol . '://maps.googleapis.com/maps/api/geocode/json?';
	...
	public function _check_required()
	{
		...
		if(!isset($this->_params['address']) AND !isset($this->_params['latlng']) AND !isset($this->_params['components']))
		{
			$r[] = 'address';
		}
